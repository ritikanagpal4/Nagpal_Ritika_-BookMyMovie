            ...
            <div>
                <header className="app-header">
                    ...
                    {!this.state.loggedIn ?
                        ...
                        :
                        <div className="login-button">
                            <Button variant="contained" color="default" onClick={this.onLogout}>
                                Logout
                            </Button>
                        </div>
                    }
                ...
                >
                    ...
                    {this.state.value === 0 &&
                        <TabContainer>
                            <FormControl required>
                                ...
                                <Input id="username" type="text" username={this.state.username} onChange={this.onInputUsername} />
                            ...
                            <FormControl required>
                                ...
                                <Input id="loginPassword" type="password" loginpassword={this.state.loginPassword} onChange={this.onInputLoginPassword} />
                    ...
                    {this.state.value === 1 &&
                        <TabContainer>
                            ...
                            <br /><br />
                            <Button variant="contained" color="primary" onClick={this.onRegisterClick}>REGISTER</Button>
                        </TabContainer>
                    }
                </Modal>
            </div>
